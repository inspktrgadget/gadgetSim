...
write_gadget_file <- function(gf, path) {
    UseMethod("write_gadget_file")
}

write_gadget_file.gadget_main <- function(gf, path) {
    if (is.null(obj)) {
...
write_gadget_file.gadget_time <- function(gf, path) {

}

write_gadget_file.gadget_area <- function(gf, path) {

}

write_gadget_file.gadget_printfile <- function(gf, path) {

}

write_gadget_file.gadget_params <- function(gf, path) {

}

write_gadget_file.gadget_stock <- function(gf, path) {

}

write_gadget_file.gadget_fleet <- function(gf, path) {

}

write_gadget_attributes <- function(gf, path) {
